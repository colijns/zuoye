...
enum { WAN_DAO, XIANG_RI_KUI, SHI_REN_HUA,JIAN_GUO,DA_JIAN_GUO,MAOMAO, ZHI_WU_COUNT };
...
int ballMax = sizeof(balls) / sizeof(balls[0]);	//阳光池中阳光的总数
